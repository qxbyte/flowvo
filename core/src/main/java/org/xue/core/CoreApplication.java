...
public class CoreApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws JsonProcessingException {
        ...
        List<Tool> list = FunctionDefinitionScanner.scan_(FunctionRegistry.class);   // 扫描指定包下所有类中的函数调用
//        List<Tool> list = FunctionDefinitionScanner.scanPackage("org.xue.assistant.functioncall.executor");

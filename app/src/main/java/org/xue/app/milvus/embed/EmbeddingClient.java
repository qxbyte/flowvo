package org.xue.app.milvus.embed;
...
public class EmbeddingClient {
    ...
    private final RestTemplate milvusRestTemplate;

    @Autowired
    public EmbeddingClient(@Value("${local.embedding.server}") String baseUrl, RestTemplate milvusRestTemplate) {
        this.baseUrl = baseUrl;
        this.milvusRestTemplate = milvusRestTemplate;
    }
    ...
    public List<String> split(String text) {
        ...
        try {
            ResponseEntity<Map> resp = milvusRestTemplate.postForEntity(baseUrl + "/split", req, Map.class);
    ...
    public List<Float> embedOne(String text) {
        ...
        req.put("text", text);
        try {
            ResponseEntity<Map> resp = milvusRestTemplate.postForEntity(baseUrl + "/embed_one", req, Map.class);
    ...
    public List<List<Float>> embedBatch(List<String> texts) {
        ...
        try {
            ResponseEntity<Map> resp = milvusRestTemplate.postForEntity(baseUrl + "/embed_batch", req, Map.class);
    ...
    public List<ChunkEmbedding> splitEmbed(String docText) {
        ...
        try {
            ResponseEntity<Map> resp = milvusRestTemplate.postForEntity(baseUrl + "/split_embed", req, Map.class);
